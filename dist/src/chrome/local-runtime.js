...
var LocalRuntime = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, util_1.uploadToS3(data, options && options.fileNameS3, 'image/png')];
    ...
    LocalRuntime.prototype.returnPdf = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, filePath, fileNameS3, cdpOptions, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = options || {
                        ...
                        }, filePath = _a.filePath, fileNameS3 = _a.fileNameS3, cdpOptions = __rest(_a, ["filePath", "fileNameS3"]);
                        return [4 /*yield*/, util_1.pdf(this.client, cdpOptions)];
                    case 1:
                        data = _b.sent();
                        if (!util_1.isS3Configured()) return [3 /*break*/, 3];
                        return [4 /*yield*/, util_1.uploadToS3(data, fileNameS3, 'application/pdf')];
